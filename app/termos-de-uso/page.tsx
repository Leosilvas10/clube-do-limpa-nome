...
export default function TermosDeUso() {
  return (
    <main className="min-h-screen bg-[#f8fafc] flex flex-col items-center pb-16">
      {/* Cabeçalho com fundo azul e logo */}
      <section className="w-full bg-[#3cb6e3] flex items-center px-6 py-6">
        <div className="flex items-center gap-4 max-w-5xl w-full mx-auto">
          <Image
            src="/images/logo-clube-do-limpa-nome-azul.png"
            alt="Clube Limpa Nome"
            width={70}
            height={70}
          ...
          <div>
            ...
            <p className="text-white text-sm mt-1">Última atualização: 16/06/2025</p>
          </div>
        </div>
      </section>

      {/* Conteúdo */}
      <section className="w-full max-w-3xl bg-white rounded-xl shadow-md mt-8 px-6 py-10">
        <p className="mb-6 text-gray-700">
          Bem-vindo ao <span className="font-semibold text-[#3cb6e3]">Clube Reconquista</span>, uma plataforma que oferece planos acessíveis para auxiliar pessoas com restrições no nome a reconquistar sua liberdade financeira por meio de processos administrativos e judiciais devidamente fundamentados.
        </p>
        <p className="mb-8 text-gray-700">
          Ao acessar ou contratar nossos serviços, você declara que leu, entendeu e concorda com estes Termos de Uso.
        </p>

        <hr className="my-6 border-[#3cb6e3]" />

        <h2 className="font-bold text-[#3cb6e3] text-lg mt-6 mb-2">1. OBJETIVO</h2>
        ...
        <h2 className="font-bold text-[#3cb6e3] text-lg mt-6 mb-2">2. DA CONTRATAÇÃO</h2>
        <ul className="list-disc pl-5 text-gray-800 mb-4">
        ...
        <h2 className="font-bold text-[#3cb6e3] text-lg mt-6 mb-2">3. DOS SERVIÇOS PRESTADOS</h2>
        <ul className="list-disc pl-5 text-gray-800 mb-4">
        ...
        <h2 className="font-bold text-[#3cb6e3] text-lg mt-6 mb-2">4. OBRIGAÇÕES DO CONTRATANTE</h2>
        <ul className="list-disc pl-5 text-gray-800 mb-4">
        ...
        <h2 className="font-bold text-[#3cb6e3] text-lg mt-6 mb-2">5. DOS PRAZOS</h2>
        <ul className="list-disc pl-5 text-gray-800 mb-4">
        ...
        <h2 className="font-bold text-[#3cb6e3] text-lg mt-6 mb-2">6. DAS CONTEMPLAÇÕES</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="font-bold text-[#3cb6e3] text-lg mt-6 mb-2">7. LIMITAÇÃO DE RESPONSABILIDADE</h2>
        <ul className="list-disc pl-5 text-gray-800 mb-4">
        ...
        <h2 className="font-bold text-[#3cb6e3] text-lg mt-6 mb-2">8. POLÍTICA DE CANCELAMENTO</h2>
        <ul className="list-disc pl-5 text-gray-800 mb-4">
        ...
        <h2 className="font-bold text-[#3cb6e3] text-lg mt-6 mb-2">9. PRIVACIDADE E PROTEÇÃO DE DADOS</h2>
        <p className="text-gray-700 mb-4">
        ...
        <h2 className="font-bold text-[#3cb6e3] text-lg mt-6 mb-2">10. DISPOSIÇÕES FINAIS</h2>
        <p className="text-gray-700 mb-4">
        ...
        <div className="mt-8 text-gray-800 text-sm">
          <span className="font-bold text-[#3cb6e3]">Clube Limpa Nome</span><br />
          Grupo responsável: O Meu Crédito Ltda sob o CNPJ 43.932982/0001-62<br />
          Endereço: Quadra A3, B8 sala 103 Cruz das Almas-BA CEP 44.380-000
        </div>
      </section>
    </main>
  );
